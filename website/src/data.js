export const testimonials = [
  {
    ...
    role: "Architect, Nagole",
    message: "Jai Hanuman was recommended to us for a high-end luxury villa project in Nagole. Bujala Praveen's ceramic expertise is phenomenal. Their selection of huge slab vitrified tiles completely transformed the architectural look of the project. Highly recommended!",
    rating: 5
  },
  {
    name: "Ananya Reddy",
    role: "Homeowner, Hayathnagar",
    message: "The Hayathnagar showroom is massive and beautiful. We bought all our master bathroom fittings and kitchen vitrified tiles from there. The premium quality sanitary collections by Johnson and RAK are pristine. Unmatched service!",
    rating: 5
  },
  {
    name: "Surendra Babu",
    role: "Builder, Landmark Infra",
    message: "Consistently buying tiles and sanitary solutions for our apartment builds since 2015. Extremely competitive pricing, reliable fast delivery, and expert consultations. Bujala's technical knowledge prevents lots of installation errors.",
    rating: 5
  }
];
